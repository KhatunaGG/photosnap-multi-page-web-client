...
const Badge = ({ title, subText, date }: BadgePropsType) => {
  return (
    <div className="w-full absolute bottom-10 left-0 right-0 z-10 px-8 md:px-10 flex flex-col gap-[20px] cursor-pointer         transition duration-300 group-hover:scale-105">
